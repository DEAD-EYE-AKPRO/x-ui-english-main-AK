...
info_bar(){
    clear
    echo -e "${RED} AKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAK ${PLAIN}"
    echo -e "${GREEN}   __   __           _    _ _____    ______             _ _     _      THIS ${PLAIN}"
    echo -e "${GREEN}   \ \ / /          | |  | |_   _|  |  ____|           | (_)   | |          IS ${PLAIN}"
    echo -e "${GREEN}    \ V /   ______  | |  | | | |    | |__   _ __   __ _| |_ ___| |__          THE ${PLAIN}"
    echo -e "${GREEN}     > <   |______| | |  | | | |    |  __| |  _ \ / _  | | / __|  _ \            AK ${PLAIN}"
    echo -e "${GREEN}    / . \           | |__| |_| |_   | |____| | | | (_| | | \__ \ | | |           AK ${PLAIN}"
    echo -e "${GREEN}   /_/ \_\           \____/|_____|  |______|_| |_|\__, |_|_|___/_| |_|        THE ${PLAIN}"
    echo -e "${GREEN}                                                  __/ |                     IS ${PLAIN}"
    echo -e "${GREEN}                                                 |___/                 THIS ${PLAIN}"
    echo -e "${RED} AKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAKAK ${PLAIN}"
    echo ""
